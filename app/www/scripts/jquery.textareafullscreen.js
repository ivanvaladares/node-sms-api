...
(function ($) {
    ...
    var methods = {
        ...
        init: function (opts) {
            ...
            var content =
                '<div class="tx-editor-wrapper"><div class="tx-editor"><span class="tx-icon glyphicon glyphicon-fullscreen"></span><span class="tx-clear-icon glyphicon glyphicon-trash"></span></div></div>';
            var $wrapper = $(content).insertAfter(this);
            $editor = $wrapper.find('.tx-editor');
            $icon = $editor.find('.tx-icon');
            $clear = $editor.find('.tx-clear-icon');
